            ...
            <div >
                ...
                <Link to="/"> <img src="https://dewey.tailorbrands.com/production/brand_version_mockup_image/15/4097908015_46ee0ad4-45ff-4c70-9a0e-48f1c172bf9d.png?cb=1605046547" style={{width: "180px", marginRight: "50px"}}></img></Link>
                    <Nav className="mr-auto">
                        <Link to="/"><li> <Nav.Link href="#home" style={{ color: "white", fontWeight: "bold", textDecoration: "none"  }}>Home</Nav.Link>  </li></Link>
                    ...
                    <Nav.Link> <Link to="/"><button type="button" className="btn btn-link nav-link" onClick={onClickLogoutHandler} style={{ color: "white", fontWeight: "bold", textDecoration: "none" }}>Logout</button>
                    </Link></Nav.Link>
                </Navbar>
            </div>
        )
